<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['erp:Sdept_approved:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['erp:Sdept_approved:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['erp:Sdept_approved:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['erp:Sdept_approved:export']">导出</el-button>
      </el-col>
    ...
    <BaseOutcomeDialog
        ...
        :addFn="addSdept_approved"
        :updateFn="updateSdept_approved"
        titleAdd="新增成果"
        titleEdit="修改成果"
        @ok="getList"
    />
...
function getList() {
  loading.value = true;
  listSdept_approved(queryParams.value).then((res) => {
    Sdept_approvedList.value = res.rows;
