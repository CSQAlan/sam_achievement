 ...
 * @date 2026-01-26
 */
public class ErpOutcome extends BaseEntity
{
    ...
    /** 审核状态（-- 0:草稿, 1:待系部审核, 2:待校级审核, 3:已存档(通过), 4:系部驳回, 5:校级驳回） */
    @Excel(name = "审核状态", readConverterExp = "-=-,0=:草稿,,1=:待系部审核,,2=:待校级审核,,3=:已存档(通过),,4=:系部驳回,,5=:校级驳回")
    ...
    /** 报销审核时间 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "报销审核时间", width = 30, dateFormat = "yyyy-MM-dd")
    ...
    private List<ErpAttachment> attachmentList;

    public List<ErpAttachment> getAttachmentList() {
        return attachmentList;
    }

    public void setAttachmentList(List<ErpAttachment> attachmentList) {
        this.attachmentList = attachmentList;
    }

    /** 指导老师列表 */
    private List<ErpGuideTeacher> guideTeacherList;

    public List<ErpGuideTeacher> getGuideTeacherList() {
        return guideTeacherList;
    }

    public void setGuideTeacherList(List<ErpGuideTeacher> guideTeacherList) {
        this.guideTeacherList = guideTeacherList;
    }
