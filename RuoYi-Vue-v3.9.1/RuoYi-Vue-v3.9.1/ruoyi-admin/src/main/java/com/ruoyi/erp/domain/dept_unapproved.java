...
/**
 * 院级未审核的成果对象 erp_outcome
 * 
 * @author cyy
 * @date 2026-01-26
 */
public class dept_unapproved extends BaseEntity
{
    ...
    /** 审核状态（0:待院级审核, 1:院级驳回, 2:院级审核通过） */
    @Excel(name = "审核状态", readConverterExp = "0=待院级审核,1=院级驳回,2=院级审核通过")
    ...
    /** 系部审核时间 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "系部审核时间", width = 30, dateFormat = "yyyy-MM-dd")
