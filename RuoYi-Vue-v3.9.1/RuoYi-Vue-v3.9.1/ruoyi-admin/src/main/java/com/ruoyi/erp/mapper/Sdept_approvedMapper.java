...
public interface Sdept_approvedMapper
{
     ...
     *
     * @param auditStatus 审核状态列表（例如：校级已审核/校级驳回等）
     * @return 符合条件的成果集合
     */
    List<Sdept_approved> selectByAuditStatuses(@Param("auditStatus") List<Integer> auditStatus);
     ...
     * @param schoolAuditReason 校级审核原因（注意：这里用 schoolAuditReason 更符合“校级”语义）
     * @return 是否成功
     */
